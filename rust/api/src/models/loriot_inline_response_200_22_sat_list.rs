...
pub struct LoriotInlineResponse20022SatList {
    /// SV PRN number
...
impl LoriotInlineResponse20022SatList {
    pub fn new() -> LoriotInlineResponse20022SatList {
        LoriotInlineResponse20022SatList {
            id: None,
            ele: None,
            azi: None,
            snr: None,
